...
![Lab architecture overview](sentinel-soc-lab-README/Lab_architecture.png)
...
- A budget alert configured to avoid unexpected charges: **Cost Management -> Budgets -> Add a budget**, with an alert threshold set at USD 150.
  ...
  ![Budget alert configuration](sentinel-soc-lab-README/CostAlert.png)
...
![Resource hierarchy](sentinel-soc-lab-README/Microsoft_tenant_hierarchy.png)

![Creating the resource group](sentinel-soc-lab-README/Resource_group.png)
...
![Creating the virtual network](sentinel-soc-lab-README/Vnet.png)
...
![Creating the NSG](sentinel-soc-lab-README/NSG.png)

![Allowing SSH and RDP inbound](sentinel-soc-lab-README/allowlistNSG.png)

![NSG rule configuration](sentinel-soc-lab-README/Associate_Vnet.png)
...
![Creating the Windows VM](sentinel-soc-lab-README/WinVM_architecture.png)

### Step 5: Create the Linux VM

An Ubuntu Pro 20.04 LTS VM was deployed alongside the Windows VM.

![Creating the Linux VM](sentinel-soc-lab-README/LInuxVM_architecture.png)
...
![Diagnostic settings for Activity Logs](sentinel-soc-lab-README/control_plane_log_collection.png)
...
![Enabling Defender plans](sentinel-soc-lab-README/Enable_MS_defender_part1.png)

![Defender plan configuration](sentinel-soc-lab-README/Enable_MS_defender_part2.png)
...
![Sign-in error on the unified portal](sentinel-soc-lab-README/security_portal_issue.png)
...
![Empty Defender portal](sentinel-soc-lab-README/no_data_in_MS_defender_issue.png)
...
![Verifying Windows Security Events](sentinel-soc-lab-README/windows_security_events_confirming_issue.png)
...
*Screenshots referenced above are stored alongside this README under `sentinel-soc-lab-README/`.*
